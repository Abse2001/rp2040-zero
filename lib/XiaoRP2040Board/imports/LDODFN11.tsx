...
export const LDODFN11 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      supplierPartNumbers={{
      ...
      manufacturerPartNumber="TCR3UM33A_LF_SE"
      footprint={
        <footprint>
          <smtpad
            portHints={["pin2"]}
      ...
      cadModel={{
        objUrl:
          "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=9c2eebc267f642aab45e7193d1ab7813&pn=C6552142",
